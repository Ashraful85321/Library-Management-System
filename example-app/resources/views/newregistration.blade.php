...
<div class="bg-book5 bg-cover flex items-center justify-center min-h-screen max-h-full">
    ...
    <div
        ...
        <h1 class="text-2xl font-bold text-center mb-4 text-emerald-50">Add A Student</h1>
    </div>
    <div
        ...
        <h1 class="md:hidden text-2xl font-bold text-center mb-4 rmd:mb-2 text-emerald-50">Add A Student</h1>
        <form class="" action="{{route('newregistrationp')}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="mb-4">
                <label for="name" class="{{$labelClass}}">Name</label>
                <input type="name" id="name" name="name" value="" class="{{$inputClass}}">
            </div>
            <div class="mb-4">
            ...
            <button type="submit" class="bg-emerald-950 font-medium text-white p-2 w-full rounded-lg mt-3">Add</button>
        </form>
        {{-- <div>
